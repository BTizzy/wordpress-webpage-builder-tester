...
function trillium_enqueue_assets() {
    // Enqueue Satoshi font from Fontshare (TrillyCorp v10 brand font)
    wp_enqueue_style(
        'trillium-satoshi',
    ...
    // Enqueue the main stylesheet (depends on Satoshi)
    wp_enqueue_style('trillium-style', get_stylesheet_uri(), array('trillium-satoshi'), '2.0.0');

    // Enqueue JavaScript
    wp_enqueue_script('trillium-main-js', get_template_directory_uri() . '/assets/script.js', array(), '2.0.0', true);
}
