...
<main class="landing-page landing-page-startup">
    ...
    <div class="container">
        ...
        <div class="startup-services-grid">
            ...
            <div class="startup-service-card fade-in-up">
                ...
                <p>HR due diligence prep and documentation that VCs expect to see</p>
            </div>
        </div>
    </div>
</section>
...
<section class="section startup-expertise">
    <div class="container">
        <div class="startup-expertise-content fade-in-up">
            ...
            <p class="lead-text">We're not consultants who dabble in early-stage—we specialize in it. Trillium is built to help founders:</p>
            ...
            <div class="outcomes-panel fade-in-up" style="margin-top:32px">
                <h3>Outcomes backed by research</h3>
                <ul class="outcomes-list">
                    <li><strong>Cost‑effective leadership</strong> by using fractional executives during ramp‑up. <a href="https://hbr.org/2024/07/how-part-time-senior-leaders-can-help-your-business" target="_blank" rel="noopener">Harvard Business Review</a></li>
                    <li><strong>Investor‑ready systems</strong> with HR diligence aligned to funding milestones. <a href="https://www.shrm.org/topics-tools/employment-law-compliance/compliance-resources" target="_blank" rel="noopener">SHRM Compliance Resources</a></li>
...
<section class="section startup-process" id="process">
    <div class="container">
